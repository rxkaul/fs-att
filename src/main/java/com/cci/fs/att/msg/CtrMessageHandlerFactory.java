...
/**
 * A factory for creating CtrMessageHandler objects.
 * 
 * @author CCI
 * @version $Rev$
 */
@Component
public class CtrMessageHandlerFactory implements MessageHandlerFactory {
	...
	public List<MessageHandler> createMessageHandlers() {
		for (int port : ports) {
			CtrMessageHandler handler = new CtrMessageHandler(port, zkHost, fileFormatVersion,
